...
VALUES (999899, 'Jhonatan', 1000.00);
...
SET @sql = '
UPDATE MERCANTILBAK.dbo.Cuenta
SET Saldo = B.Saldo
FROM MERCANTILBAK.dbo.Cuenta A
INNER JOIN MERCANTIL.dbo.Cuenta B ON A.NumeroCuenta = B.NumeroCuenta
